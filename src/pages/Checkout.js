...
const addresses = [
    {
        name: "Rameshvar Gupta",
        email: "ram123@gmail.com",
        street: "Jungal Gulariha",
        city: "Maharajganj",
        pinCode: 273164,
        state: "Uttar Pradesh",
        phone: 7523062030
    ...
    {
        name: "Jitendra",
        email: "jitendra2004@gmail.com",
        street: "Tulasipur Chauraha",
        city: "Maharajganj",
        pinCode: 273164,
        state: "Uttar Pradesh",
        phone: 9795879759
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-0">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="border-b border-gray-900/10 pb-10">
                                ...
                                <p className="mt-1 text-sm leading-6 text-gray-600">
                                    Choose For Existing Addresss
                                </p>

                                <ul role="list">
                                    {addresses.map((address) => (

                                        <li key={address.email} className="flex justify-between gap-x-6 my-3 py-5 px-5 border-2 border-solid">
                ...
                <div className="lg:col-span-2">
                    <div className='bg-white mx-auto max-w-7xl mt-12 px-4 py-0 sm:px-0 lg:px-0"'>
